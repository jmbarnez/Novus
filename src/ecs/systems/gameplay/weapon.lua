...
function WeaponSystem:update(dt)
    ...
    for _, e in ipairs(self.pool) do
        ...
        for i = 1, #mounts do
            ...
            if is_local_shooter and not first_px then
                first_px = px
                first_py = py
            end
        ...
        if is_local_shooter and first_px and first_py then
            SoundManager.play_sound_at("laser_turret_fire", first_px, first_py)
        end
