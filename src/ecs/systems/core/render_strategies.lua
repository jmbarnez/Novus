...
local Explosions = require "src.ecs.systems.core.render_strategies.explosions"
...
function RenderStrategies.ship_explosion(e)
    Explosions.ship_explosion(e)
end
...
local DrawStrategies = {
    ...
    ship_explosion = RenderStrategies.ship_explosion,
}
...
local function resolve_type_key(e)
    ...
    if type(r) == "table" and r.type then
        if r.type == "asteroid" or r.type == "asteroid_chunk" or
            ...
            r.type == "projectile" or r.type == "procedural" or
            r.type == "ship_explosion" then
            return r.type
        else
            return "ship"
        end
