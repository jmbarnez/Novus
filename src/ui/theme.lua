...
function Theme.drawButton(x, y, w, h, label, state, font)
    ...
    love.graphics.rectangle("fill", x, y, w, h, shapes.buttonRounding or 0, shapes.buttonRounding or 0)

    love.graphics.setColor(outline)
    love.graphics.setLineWidth(shapes.outlineWidth or 1)
    love.graphics.rectangle("line", x, y, w, h, shapes.buttonRounding or 0, shapes.buttonRounding or 0)
